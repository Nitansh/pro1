...
function SpriteVariables() {
	...
	this.hero         =  new Hero((commonConfiguration.ClientWidth - commonConfiguration.rampWidth - this.Height), 300, "/game/bhero.png", true, 32, 0, true , {x : 10000 ,y : 0});
	this.backButton   =  new Sprite(commonConfiguration.ClientWidth - 20, commonConfiguration.ClientHeight - 80, "/game/pause.png", true, 1, 0, false);
	this.movable      =  movable.objects;
	//this.p1           =  
	this.p3           =  new SnowParticleSystem({x:commonConfiguration.ClientWidth, y:commonConfiguration.ClientHeight}, 50, {red:244, green:240, blue:145});
	...
	this.rocketHero   =  new RocketHero((commonConfiguration.ClientWidth - 72)/2, this.hero.y , "/game/hero_R.png",false, 2, 0, true,  {x : 5, y : 0});
